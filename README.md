...
These applications are designed to be deployed via Flux, from the `clusters/homelab` repo path.
...
│   └── ...
├── clusters # Cluster Kustomizations
│   └── homelab
├── infrastructure # Infra services to support apps
│   └── ...
└── README.md
```
