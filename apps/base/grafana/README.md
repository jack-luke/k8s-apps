...
| HelmRelease | grafana | [helm-release.yaml](helm-release.yaml) | Installs Grafana. |
| HelmRepository | grafana | [helm-repository.yaml](helm-repository.yaml) | Grafana Helm charts. |
